...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `register_employee`(in username varchar(20), in pass varchar(200), in fname varchar(50), in lname varchar(50), in em varchar(50), in id char(9), in phone varchar(12), in address varchar(50), in city varchar(20), in state char(2), in zip char(5))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `register_employee_visitor`(in username varchar(20), in pass varchar(200), in fname varchar(50), in lname varchar(50), in em varchar(50), in id char(9), in phone varchar(12), in address varchar(50), in city varchar(20), in state char(2), in zip char(5))
BEGIN
insert into user values (username, pass, 'Pending', fname, lname);
insert into employee values (username, id, phone, address, city, state, zip);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `register_user`(in username varchar(20), in pass varchar(200), in fname varchar(50), in lname varchar(50), in em varchar(50))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `register_visitor`(in username varchar(20), in pass varchar(200), in fname varchar(50), in lname varchar(50), in em varchar(50))
BEGIN
...
-- Dump completed on 2019-04-18 21:14:34
