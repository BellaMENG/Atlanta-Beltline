...
class Ui_register_employee_v(object):
    ...
    def retranslateUi(self, register_employee):
        ...
        register_employee.setWindowTitle(_translate("register_employee", "Register Employee-Visitor"))
        self.label.setText(_translate("register_employee", "Register Employee-Visitor"))
