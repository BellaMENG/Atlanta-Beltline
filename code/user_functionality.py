...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.take_transit_btn.clicked.connect(lambda:self.func(idx=15))
...
def render():
    User_Functionality = QtWidgets.QMainWindow()
    ui = Ui_Dialog()
    ui.setupUi(User_Functionality)
    User_Functionality.show()
    sys.exit(app.exec_())
    User_Functionality.close()
